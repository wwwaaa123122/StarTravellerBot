<script setup>
// 轻量内联 SVG 图标集（feather 风格，24x24 描边）
const ICONS = {
  ...
  plugins: ['<path d="M21 8l-9-5-9 5v8l9 5 9-5V8z"/><path d="M3 8l9 5 9-5"/><path d="M12 13v8"/>'],
  lock: ['<rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>'],
  clock: ['<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/>'],
  sparkles: ['<path d="M12 3l1.9 5.8L19.7 10l-5.8 1.9L12 17.7l-1.9-5.8L4.3 10l5.8-1.9L12 3z"/><path d="M19 15l.7 2.1L21.8 18l-2.1.7L19 20.8l-.7-2.1-2.1-.7 2.1-.7L19 15z"/>'],
  prompt: ['<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.83z"/><circle cx="7" cy="7" r="1.6"/>'],
  ...
  fold: ['<path d="M11 17l-5-5 5-5"/><path d="M18 17l-5-5 5-5"/>'],
...
<template>
  <svg
    ...
    aria-hidden="true"
    v-html="ICONS[name] ? ICONS[name].join('') : ''"
  ></svg>
</template>
